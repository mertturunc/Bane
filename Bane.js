...
bot.on("guildCreate", guild => {
	console.log("Yeni bir sunucuya katıldım, adı " + guild.name + " ve sahibi " + guild.owner.user.username);
});

bot.on("guildDelete", guild => {
	console.log("Bir sunucudan ayrıldım, " + guild.name + " ve sahibi " + guild.owner.user.username);
});
